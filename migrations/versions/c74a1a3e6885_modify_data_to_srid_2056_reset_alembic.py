"""Modify data to SRID 2056, reset alembic

Revision ID: c74a1a3e6885
Revises:
Create Date: 2024-04-09 09:41:59.949337
...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_soiltype_iterator"), "soiltype", ["iterator"], unique=False
    )
    op.create_index(
        op.f("ix_soiltype_name"), "soiltype", ["name"], unique=False
    )
    op.create_geospatial_table(
        "sensor",
        sa.Column("name", sqlmodel.sql.sqltypes.AutoString(), nullable=False),
    ...
    op.create_index(
        op.f("ix_sensor_time_ingested_at_utc"),
        "sensor",
        ["time_ingested_at_utc"],
        unique=False,
    )
    op.create_index(
        op.f("ix_sensor_time_recorded_at_utc"),
        "sensor",
        ["time_recorded_at_utc"],
        unique=False,
    )
    op.create_geospatial_table(
        "soilprofile",
        ...
        sa.Column(
            "weather", sqlmodel.sql.sqltypes.AutoString(), nullable=True
        ),
        sa.Column(
            "topography", sqlmodel.sql.sqltypes.AutoString(), nullable=True
        ),
        sa.Column("date_created", sa.DateTime(), nullable=True),
        sa.Column(
            "soil_type_id", sqlmodel.sql.sqltypes.GUID(), nullable=False
        ),
        sa.Column("iterator", sa.Integer(), nullable=False),
        sa.Column("id", sqlmodel.sql.sqltypes.GUID(), nullable=False),
        sa.Column(
    ...
    op.create_index(
        op.f("ix_soilprofile_date_created"),
        "soilprofile",
        ["date_created"],
        unique=False,
    )
    op.create_index(
        op.f("ix_soilprofile_id"), "soilprofile", ["id"], unique=False
    )
    op.create_index(
        op.f("ix_soilprofile_iterator"),
        "soilprofile",
        ["iterator"],
        unique=False,
    )
    op.create_index(
        op.f("ix_soilprofile_name"), "soilprofile", ["name"], unique=False
    )
    op.create_index(
        op.f("ix_soilprofile_soil_type_id"),
        "soilprofile",
        ["soil_type_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_sensordata_soil_moisture_count"),
        "sensordata",
        ["soil_moisture_count"],
        unique=False,
    )
...
def downgrade() -> None:
    ...
    op.create_table(
        "countysub_lookup",
        sa.Column(
            "st_code", sa.INTEGER(), autoincrement=False, nullable=False
        ),
        sa.Column(
            "state", sa.VARCHAR(length=2), autoincrement=False, nullable=True
        ),
        sa.Column(
            "co_code", sa.INTEGER(), autoincrement=False, nullable=False
        ),
        sa.Column(
            "county", sa.VARCHAR(length=90), autoincrement=False, nullable=True
        ),
        sa.Column(
            "cs_code", sa.INTEGER(), autoincrement=False, nullable=False
        ),
        sa.Column(
    ...
    op.create_table(
        ...
        sa.Column(
            "side", sa.VARCHAR(length=1), autoincrement=False, nullable=True
        ),
        sa.Column(
            "zip", sa.VARCHAR(length=5), autoincrement=False, nullable=True
        ),
        sa.Column(
        ...
        sa.Column(
            "fromarmid", sa.INTEGER(), autoincrement=False, nullable=True
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "statefp", sa.CHAR(length=2), autoincrement=False, nullable=True
        ),
    ...
    op.create_geospatial_table(
        ...
        sa.Column(
            "lsad", sa.VARCHAR(length=2), autoincrement=False, nullable=True
        ),
        sa.Column(
        ...
        sa.CheckConstraint(
            "st_ndims(the_geom) = 2", name="enforce_dims_the_geom"
        ),
        sa.CheckConstraint(
    ...
    op.create_geospatial_table(
        ...
        sa.Column(
            "zipl", sa.VARCHAR(length=5), autoincrement=False, nullable=True
        ),
        sa.Column(
            "zipr", sa.VARCHAR(length=5), autoincrement=False, nullable=True
        ),
        sa.Column(
        ...
        sa.Column(
            "ttyp", sa.VARCHAR(length=1), autoincrement=False, nullable=True
        ),
        sa.Column(
            "deckedroad",
            sa.VARCHAR(length=1),
    ...
    op.create_index(
        "idx_tiger_edges_countyfp", "edges", ["countyfp"], unique=False
    )
    ...
    op.create_geospatial_table(
        ...
        sa.CheckConstraint(
            "st_srid(the_geom) = 4269", name="enforce_srid_geom"
        ),
    ...
    op.create_geospatial_table(
        ...
        sa.Column(
            "uace", sa.VARCHAR(length=5), autoincrement=False, nullable=True
        ),
        sa.Column(
    ...
    op.create_index(
        "idx_tiger_faces_countyfp", "faces", ["countyfp"], unique=False
    )
    op.create_table(
        "loader_variables",
        sa.Column(
        ...
        sa.Column(
            "website_root", sa.TEXT(), autoincrement=False, nullable=True
        ),
        sa.Column(
            "staging_fold", sa.TEXT(), autoincrement=False, nullable=True
        ),
        sa.Column(
            "data_schema", sa.TEXT(), autoincrement=False, nullable=True
        ),
        sa.Column(
            "staging_schema", sa.TEXT(), autoincrement=False, nullable=True
        ),
    ...
    op.create_table(
        ...
        sa.PrimaryKeyConstraint(
            "st_code", "co_code", name="county_lookup_pkey"
        ),
    )
    op.create_index(
    ...
    op.create_geospatial_table(
        ...
        sa.Column(
            "name", sa.VARCHAR(length=7), autoincrement=False, nullable=True
        ),
        sa.Column(
            "namelsad",
    ...
    op.create_table(
        "zip_lookup_base",
        sa.Column(
            "zip", sa.VARCHAR(length=5), autoincrement=False, nullable=False
        ),
        sa.Column(
    ...
    op.create_table(
        ...
        sa.Column(
            "pl_code", sa.INTEGER(), autoincrement=False, nullable=False
        ),
        sa.Column(
            "name", sa.VARCHAR(length=90), autoincrement=False, nullable=True
        ),
        sa.PrimaryKeyConstraint(
            "st_code", "pl_code", name="place_lookup_pkey"
        ),
    )
    op.create_index(
    ...
    op.create_table(
        ...
        sa.PrimaryKeyConstraint(
            "lookup_name", name="loader_lookuptables_pkey"
        ),
    )
    op.create_table(
        "geocode_settings",
    ...
    op.create_geospatial_table(
        ...
        sa.Column(
            "ur", sa.VARCHAR(length=1), autoincrement=False, nullable=True
        ),
        sa.Column(
            "uace", sa.VARCHAR(length=5), autoincrement=False, nullable=True
        ),
    ...
    op.create_geospatial_table(
        ...
        sa.Column(
            "cpi", sa.VARCHAR(length=1), autoincrement=False, nullable=True
        ),
        sa.Column(
    ...
    op.create_table(
        "loader_platform",
        sa.Column(
            "os", sa.VARCHAR(length=50), autoincrement=False, nullable=False
        ),
        sa.Column(
            "declare_sect", sa.TEXT(), autoincrement=False, nullable=True
        ),
        sa.Column("pgbin", sa.TEXT(), autoincrement=False, nullable=True),
        sa.Column("wget", sa.TEXT(), autoincrement=False, nullable=True),
        sa.Column(
            "unzip_command", sa.TEXT(), autoincrement=False, nullable=True
        ),
    ...
    op.drop_index(
        op.f("ix_sensordata_soil_moisture_count"), table_name="sensordata"
    )
    ...
    op.drop_index(
        op.f("ix_soilprofile_soil_type_id"), table_name="soilprofile"
    )
    ...
    op.drop_index(
        op.f("ix_soilprofile_date_created"), table_name="soilprofile"
    )
    op.drop_geospatial_index(
        "idx_soilprofile_geom",
        table_name="soilprofile",
        postgresql_using="gist",
        column_name="geom",
    )
